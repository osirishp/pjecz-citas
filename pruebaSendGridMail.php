                          ...
                          <div class="modal-dialog text-center">
                            ...
                            <form class="col-12" method="post">
                              <div class="col-sm-12 text-center">
                                <a style="border-top: 1px solid#888; border-bottom: 1px solid#888; padding-top: 12px; padding-bottom: 12px;font-weight: bold; font-size:1.2em; color:orange; margin-top:10px" href="SendGridMail.php">Enviar prueba sendgrid</a>
                                <br>  <br>
                              </div>
                            </form>                        
                          </div>
