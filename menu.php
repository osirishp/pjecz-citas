      <div class="collapse navbar-collapse nav-wil " id="bs-example-navbar-collapse-1" >
          <ul class="nav navbar-nav" style="display:inline">
              ...
              <!--li ><a href="reportes.php" class="hvr-bounce-to-bottom" >Reportes</a></li -->              
               <li ><a href="calendario.php" class="hvr-bounce-to-bottom">Calendario</a></li>
               <li ><a href="actividades.php" class="hvr-bounce-to-bottom">Actividades del d&iacute;a</a></li>               
               <?php 
